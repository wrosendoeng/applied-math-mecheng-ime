...
program main
    ...
    real(fgsl_double), parameter :: bar_length = 2.0_fgsl_double, end_time = 10.0_fgsl_double ! Length in meters
    real(fgsl_double) :: dxvec, start, finish
    ...
    open(newunit=new_unit1,file=file_name//"_"//trim(unit1)//".txt",status="replace",action="write")
    open(newunit=new_unit2,file=file_name//"_"//trim(unit1)//".txt",status="replace",action="write")
    ...
    print *, "CPU time spent in code with "//arg1//" parcels: ", finish-start
end program main2